...
function Navbar() {
    ...
    return (
        <nav className={`bg-gray-800 relative min-h-12 ${isDarkMode ? 'theme-dark' : 'theme-light'}`}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-12 min-h-12">
                ...
                <div className="mode-switch inline-flex items-center justify-center pt-0.5">
    <label className="switch">
        <input type="checkbox" checked={isDarkMode} onChange={handleToggle} />
        <span className="slider flex items-center justify-center">
